...
/* Create a stored procedure called 'uspGetAddress2' and give control of it to the database owner */
CREATE PROCEDURE dbo.uspGetAddress2 @City NVARCHAR(30)
AS
SELECT * FROM Person.Address /* SELECT all rows in the address column */
